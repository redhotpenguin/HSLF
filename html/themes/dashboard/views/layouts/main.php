                            ...
                            array(
                                ...
                                'items' => array(
                                    ...
                                    array('label' => 'Publishing', 'url' => '#', 'items' => array(
                                            array('label' => 'States', 'url' => array('/state/dashboard'), 'visible' => isAdmin()),
                                            array('label' => 'Districts', 'url' => array('/district/dashboard'), 'visible' => isAdmin() ),
                                            array('label' => 'Recommendations', 'url' => array('/recommendation/dashboard'), 'visible' => isAdmin() ),
                                            array('label' => 'Ballot Items', 'url' => array('/ballotItem/dashboard'), 'visible' => !Yii::app()->user->isGuest),
