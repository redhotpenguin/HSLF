<?php
/**
 * CDbCriteriaInsensitive class file.
 *
 * @author Qiang Xue <qiang.xue@gmail.com> - hacked by Jonas Palmero to support insentisive search (postgresql)
...
/**
 * CDbCriteriaInsensitive represents a query criteria, such as conditions, ordering by, limit/offset.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: CDbCriteriaInsensitive.php 3515 2011-12-28 12:29:24Z mdomba $
 * @package system.db.schema
 * @since 1.0
 */
class CDbCriteriaInsensitive extends CComponent
{
	 ...
	 * @return CDbCriteriaInsensitive the criteria object itself
	 */
	 ...
	 * @param mixed $criteria the criteria to be merged with. Either an array or CDbCriteriaInsensitive.
