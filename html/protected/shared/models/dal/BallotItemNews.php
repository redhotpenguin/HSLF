 ...
 */
class BallotItemNews extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('ballot_item_id, title, date_published', 'required'),
			array('ballot_item_id', 'numerical', 'integerOnly'=>true),
			array('content, excerpt', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, ballot_item_id, title, content, excerpt, date_published', 'safe', 'on'=>'search'),
		);
	}
