 ...
 * 
 * Updated by Jonas Palmero (added revokeAll())
 */
 ...
 * @since 1.0
 */
class MyCDbAuthManager extends CAuthManager {
    ...
    /**
     * Revokes all authorizations assignment from a user.
     * @param mixed $userId the user ID (see {@link IWebUser::getId})
     * @return boolean whether removal is successful
     */
