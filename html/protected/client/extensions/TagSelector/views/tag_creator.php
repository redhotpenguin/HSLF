<div id="new_tag_form" class="form">
    ...
    <div class="row">
        ...
        echo Chtml::textField('display_name', '', array('class' => 'span7', 'size' => 60,'style'=>'width: 310px;', 'placeholder' => 'Example: City of Portland'));
        ?>
    ...
    <div class="row">
        ...
        echo Chtml::textField('name', '', array('class' => 'span7', 'size' => 60, 'maxlength' => 255, 'style'=>'width: 310px;','placeholder' => 'Example: org_city_portland'));
