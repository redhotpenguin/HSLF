...
<div class="row-fluid">  
    ...
    if ($model->isNewRecord) {
        echo $form->labelEx($model, 'recipient_type');
        echo $form->textField($model, 'recipient_type', array('class' => 'span12', 'rows' => '4', 'placeholder' => 'tag or broadcast'));
    } else {
        echo $form->hiddenField($model, 'recipient_type');
    }
    ?>
</div>
