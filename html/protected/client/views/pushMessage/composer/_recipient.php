...
<div id="recipientSection">
    ...
    <div id="recipient-options">
        ...
        <div id="singleDeviceChoice">
            <p class="helpText">A unique device identified by an ID. Find this ID by opening a user's record from the <?php echo Chtml::link("browse", array("mobileUser/browse"), array("target"=>"_blank")); ?>  screen and looking for the ua_identifier. This is not the same as the App ID.</p>
