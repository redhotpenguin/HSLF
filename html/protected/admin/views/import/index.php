...
<div class="form">
    ...
    <div class="clearfix"></div>
    <p>
        <b>CSV structure:</b> id, district_id, item, item_type, recommendation_id, next_election_date, detail, date_published, published, party_id, image_url, election_result_id, url, personal_url, score, office_id, facebook_url, twitter_handle, hold_office, facebook_share, twitter_share, measure_number, friendly_name
        <br/>
        (headers must be included)
    </p>
    <?php
