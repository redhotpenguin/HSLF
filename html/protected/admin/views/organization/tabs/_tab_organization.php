<div class="">
    ...
    echo $form->textField($model, 'name', array('size' => 60, 'class' => 'span7', 'maxlength' => 512));
...
<div class="">
    ...
    echo $form->textField($model, 'display_name', array('size' => 60, 'class' => 'span7'));
...
<div class="">
    ...
    echo $form->textField($model, 'slug', array('size' => 60, 'class' => 'span7'));
...
<div class="">
    ...
    echo $form->textField($model, 'facebook_url', array('size' => 60, 'maxlength' => 1024, 'class' => 'span7'));
...
<div class="">
    ...
    echo $form->textField($model, 'twitter_handle', array('size' => 60, 'maxlength' => 140, 'class' => 'span7'));
...
<div class="">
    ...
    echo $form->textArea($model, 'address', array('cols' => 60, 'rows' => 3, 'class' => 'span7'));
