...
class CandidateController extends Controller {
    ...
    public function actionAdmin() {
        ...
        $district_number = trim($_GET['Candidate']['district_number']);
        if ($district_number != '' && !is_numeric($district_number)) {
            throw new CHttpException(400, 'Please enter a valid district number');
        }
