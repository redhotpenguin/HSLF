...
if ($connected == false) {
    echo 'abIncident reported: ' . $_SERVER['REMOTE_ADDR'] . ' tried to access a secured area without proper privileges.';
...
if (file_exists('/home/dotcloud/environment.json')) {
    ...
    $mcImageManagerConfig['preview.urlprefix'] = "{proto}://{host}/content"; // domain name
}
else
...
//$mcImageManagerConfig['authenticator'] = "Authenticator";
$mcImageManagerConfig['authenticator.logSessionin_page'] = "login_session_auth.php";
